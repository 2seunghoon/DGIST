...
def get_dataset(dataset, batch, imsize, workers, super_class=None):
    if dataset == 'G':
        # train_dataset = GTA5_2(list_path='./data_list/GTA5', split='train', crop_size=imsize)
        # test_dataset = None

        # for transfer_2img
        train_dataset = F_model(list_path='./data_list/GTA5', split='train', crop_size=imsize)
        test_dataset = None
    elif dataset == 'C':
