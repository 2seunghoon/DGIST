...
class Imgnet(Cityscapes):
    def __init__(self,
                 list_path='./data_list/imagenet-mini',
                 split='train',
                 crop_size=(1024, 512),
                 train=True,
        ...
        # label_list_filepath = os.path.join('./data_list/GTA5', self.split + "_labels.txt")
        ...
        print("{} num images in IMGNET-MINI {} set have been loaded.".format(len(self.images), self.split))
